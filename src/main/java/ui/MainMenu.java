...
public class MainMenu {
    ...
    public static void main(String[] args){
        ...
        // test
        Teacher fenDean = new Teacher ("11111", "Глущенко", "Олександра","Степанівна", LocalDate.of(1972,4,12), "hlushchenkoas@ukma.edu.ua", "+380956387102", null, Position.DEAN, AcademicDegree.DOCTOR, AcademicTitle.PROFESSOR, "01.09.2005", 48000);
        Faculty fen = new Faculty ("1111111", "Факультет економічних наук", "ФЕН", fenDean, "6-403, +380444256042");
        Teacher financeHead = new Teacher ("33333", "Слав'янська", "Наталія","Миколаївна", LocalDate.of(1965, 8,25), "slavyanska.nm@ukma.edu.ua", "+380444256042", null, Position.HEAD, AcademicDegree.CANDIDATE, AcademicTitle.DOCENT, "15.8.1998", 36500);
        ...
        Teacher marketingHead = new Teacher ("44444", "Фаріон", "Наталія","Миколаївна", LocalDate.of(1978,11,5), "farion.nm@ukma.edu.ua", "+380444635928", null, Position.HEAD, AcademicDegree.CANDIDATE, AcademicTitle.DOCENT, "01.09.2010", 34000);
        ...
        Teacher fenTeacher = new Teacher ("77777", "Пічик", "Катерина","Валеріївна", LocalDate.of(1983,6,18), "pichyk.kv@ukma.edu.ua", "+380679998877", marketing, Position.TEACHER, AcademicDegree.CANDIDATE, AcademicTitle.DOCENT, "1.9.2012", 31500);
        ...
        Teacher fiDean = new Teacher ("22222", "Глибовець", "Андрій","Миколайович", LocalDate.of(1975,5,15), "hlybovets@ukma.edu.ua", "+380444256057", null, Position.DEAN, AcademicDegree.DOCTOR, AcademicTitle.PROFESSOR, "1.9.2003", 45000);
        Faculty fi = new Faculty ("2222222", "Факультет інформатики", "ФІ", fiDean, "1-321, +380444256057");
        Teacher informatikaHead = new Teacher ("55555", "Глибовець", "Микола","Миколайович", LocalDate.of(1948,11,2),"m.hlybovets@ukma.edu.ua", "+380444636931", null, Position.HEAD, AcademicDegree.DOCTOR, AcademicTitle.PROFESSOR, "15.8.1992", 42000);
        ...
        Teacher merezhkiHead = new Teacher ("66666", "Бублик", "Володимир","Васильович", LocalDate.of (1962,9,3), "v.bublyk@ukma.edu.ua", "+380444238126", null, Position.HEAD, AcademicDegree.CANDIDATE, AcademicTitle.DOCENT, "20.1.2005", 34800);
        ...
        Teacher fiTeacher = new Teacher ("88888", "Трохимчук", "Олександр", "Степанович", LocalDate.of(1968, 2, 12), "trokhymchuk@ukma.edu.ua", "+380671234567", merezhki, Position.TEACHER, AcademicDegree.DOCTOR, AcademicTitle.PROFESSOR, "10.9.2001", 38200);
